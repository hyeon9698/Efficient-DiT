...
echo "Testing ratio=0.3, 0.4, 0.5 (deviation=0.2 fixed)"
echo "========================================"
...
echo "  Baseline (GPU 4)"
echo "  SDTM r=0.3 (GPU 5)"
echo "  SDTM r=0.4 (GPU 6)"
echo "  SDTM r=0.5 (GPU 7)"

wait $PID_0 && echo "  Baseline done."
wait $PID_1 && echo "  r=0.3 done."
wait $PID_2 && echo "  r=0.4 done."
wait $PID_3 && echo "  r=0.5 done."
